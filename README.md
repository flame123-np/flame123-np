...
An Information Technology student with a strong passion for Business Analysis. Driven and skilled in gathering user requirements, mapping business workflows, and effectively bridging the gap between stakeholders and development teams.
...
![PlatformIO](https://img.shields.io/badge/PlatformIO-F38020?style=for-the-badge&logo=platformio&logoColor=white)
![Docker](https://img.shields.io/badge/Docker-2496ED?style=for-the-badge&logo=docker&logoColor=white)
![Figma](https://img.shields.io/badge/Figma-F24E1E?style=for-the-badge&logo=figma&logoColor=white)
![Git](https://img.shields.io/badge/Git-F05032?style=for-the-badge&logo=git&logoColor=white)

### 🎮 Game Engines & 3D Modeling
...
| 🏢 Project Name | 🌐 Domain / Tech Stack | ⏰ Timeline |
| :--- | :--- | :--- |
| **Online Movie Ticket Booking System** <br>• Analyzed user requirements and mapped out end-to-end business workflows.<br>• Designed system architecture (Use Case, Class Diagrams, DFD). | System Analysis & Design | 2026 |
| **Online Movie Ticket Booking System (Full-Stack)** <br>• Developed a responsive web app with real-time seat selection and secure checkout.<br>• Managed cloud database using Firebase and API integration via JSON. | Full-Stack Web Dev <br>(HTML, CSS, JS, Firebase) | 2026 |
| **IoT-Based Alcohol Measurement Device** <br>• Designed end-to-end IoT architecture via Wi-Fi/MQTT protocols.<br>• Developed firmware to process sensor inputs for real-time BAC monitoring. | IoT & Data Integration <br>(Hardware, Firmware, Cloud) | 2026 |
